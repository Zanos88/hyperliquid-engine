...
| **Round 1 factor study** | RE-RUN (same frozen snapshots; originals archived `research/output/pre_fisher_fix/`) | Null (no cell above calibration bar) | **Null again, quieter**: exceedances 0/1/0/0 vs ~2.9 expected; bars 2.56–3.35; F4-extreme cells now fire ~never (as a correct rare-extreme should). No candidate. |
